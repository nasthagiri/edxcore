...
"""
edxcore documentation build configuration file.
...
latex_documents = [
    (master_doc, 'edxcore.tex', 'edxcore Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'edxcore', 'edxcore Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'edxcore', 'edxcore Documentation',
     author, 'edxcore', 'Common edx core utilities.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edxcore'),
                os.path.join(root_path, 'edxcore/migrations')])
